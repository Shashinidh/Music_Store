...
<div class="header">
 ...
 <form action="UpdateData" method="post"style="position: relative;left:600px; top: 50px;">
     <div class ="formtext">
    <pre>
MUSIC ID   :  <input type="text" name="sid">
...
ARTIST 	   :  <input type="text" name="martist">
   		 ...
   		 <input type="submit" value="UPDATE" style="height:40px; width:80px">
